...
public class MP_PointToPointNavigation : MonoBehaviour
{
    class InputSample
    {
    ...
    private void UpdatePointOnPath()
    {
        ...
        Debug.Log(new Vector3(90.0f, (float)headingDegrees, 0.0f));

        m_mainCamera.transform.localEulerAngles = new Vector3(2.0f, (float)headingDegrees, 0.0f);
    }
